  ...
  return (
    <div>
      <div className="container">
        <div className="border-2 border-purple-400 w-[300px] h-[330px] rounded-[10px] ">
          <img
            src={el.url}
            alt={el.title}
          ...
          <div className="px-[20px] py-[15px] flex items-center justify-between">
            <div className="flex flex-col gap-2">
              <h1 className="text-white font-bold text-[20px]">{el.title}</h1>
              <h1 className="text-white font-bold">{el.price} $</h1>
            </div>
